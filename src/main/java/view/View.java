...
public class View {
    public static final String OPENING_DASH_SYMB = "(" ;
    public static final String CLOSING_DASH_SYMB = ")" ;
    public static final String POINT_DIVIDE_SYMB = ";" ;
    ...
    public static final String TYPE_ERROR_MSG
                                         = "Your type was invalid! Try again!";
